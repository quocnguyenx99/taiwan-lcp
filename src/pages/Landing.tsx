...
import ContestClosed from "../components/ContestClosed";
...
const Landing: React.FC = () => {
  ...
  useEffect(() => {
    const checkContestStatus = () => {
      const now = new Date();
      // Ngày 21/09/2025 lúc 16:30 (UTC+7)
      const contestEndTime = new Date("2025-09-21T16:30:00+07:00");
    ...
    // Tạo interval để check mỗi phút
    const interval = setInterval(checkContestStatus, 60000); // 60 seconds
  ...
  return (
    <>
          ...
          <section className="landing-form" id="vote">
            <div className="landing-form__container">
              <div className="predict-cta">
                <div className="predict-cta__title">
                ...
                <div className="predict-form">
                  ...
                  >
                    ...
                    <div className="predict-terms__inner">
                      ...
                      <p>
                        <strong>
                          THỂ LỆ TRÒ CHƠI "BÌNH CHỌN ĐỘI CHIẾN THẮNG CHUNG KẾT
                          LCP 2025"
                        </strong>
                        <br />
                        <br />
                        <strong>Tên trò chơi:</strong> "BÌNH CHỌN ĐỘI CHIẾN
                        THẮNG CHUNG KẾT LCP 2025"
                        <br />
                        <br />
                        ...
                        <br />
                        Công dân có quốc tịch Việt Nam hiện đang cư trú trên
                        phạm vi lãnh thổ Việt Nam.
                        <br />
                        Trường hợp công dân tham gia chương trình chưa đủ 18
                        tuổi phải có sự đồng ý của người giám hộ (ba, mẹ hoặc
                        người thân trong gia đình từ 18 trở lên) và giấy tờ tùy
                        thân (CMND/CCCD/hộ chiếu) trong trường hợp nhận thưởng.
                        <br />
                        ...
                        <br />
                        👌 Bước 2: Bình chọn cho đội bạn dự đoán giành chiến
                        thắng LCP 2025 - Giải đấu vô địch{" "}
                        <strong>
                        ...
                        <br />
                        Địa chỉ nhận quà: Vui lòng cung cấp địa chỉ trước sáp
                        nhập
                        <br />
                        (*Lưu ý: Số điện thoại tham gia ứng với mỗi người chơi
                        là duy nhất. 1 số điện thoại được phép tham gia 1 lần)
                        <br />
                        <br />
                        ...
                        sẽ được xem là hợp lệ. Các lượt tham gia ngoài khoảng
                        thời gian này sẽ không được tính.
                        <br />
                        Số điện thoại tham gia phải là số điện thoại chính chủ
                        và còn tồn tại đến hết thời gian trao giải.
                        <br />
                        Người chơi không được sử dụng số điện thoại của người
                        khác (trừ trường hợp người tham gia chưa đủ 18 tuổi và
                        sử dụng số điện thoại của người giám hộ. Trường hợp này
                        sẽ cần các chứng từ chứng thực: CCCD, hộ khẩu,... theo
                        yêu cầu cụ thể tương ứng của Cục Du lịch Đài Loan văn
                        phòng tại Thành phố Hồ Chí Minh khi người chơi nhận
                        giải).
                        <br />
                        <br />
                        <strong>
                        ...
                        <br />
                        <strong>
                          - 01 giải Nhất (áp dụng cho người dự đoán đúng đội
                          chiến thắng)
                        </strong>{" "}
                        : 01 Chuyến đi Đài Loan trị giá 13 triệu đồng từ
                        Vietravel + 01 Vé vào cổng LCP cho mùa giải 2026 được tổ
                        chức tại Đài Loan
                        <br />
                        <strong>
                          - 03 giải Nhì (áp dụng cho người dự đoán đúng đội
                          chiến thắng)
                        </strong>
                        : mỗi giải 01 Vé máy bay khứ hồi đến Đài Loan từ hãng
                        hàng không EVA Air / China Airlines / STARLUX + 01 Vé
                        vào cổng LCP cho mùa giải 2026 được tổ chức tại Đài Loan
                        <br />
                        <strong>
                        ...
                        <br />
                        - Các giải được quay số may mắn trực tiếp vào 9h sáng
                        ngày 22/09/2025 tại website
                        <br />
                        *Lưu ý:
                        <br />
                        ...
                        gia có nghi vấn gian lận mà không cần thông báo đến
                        người tham dự.
                        <br />
                        <br />
                        ...
                        . Sau đó, cũng sẽ được công bố bên dưới phần bình luận
                        của bài đăng thông báo cuộc thi trên fanpage của Cục Du
                        lịch Đài Loan văn phòng tại Thành phố Hồ Chí Minh
                        <br />
                        ...
                        Trong vòng 14 ngày kể từ ngày công bố kết quả, người
                        thắng giải cung cấp thông tin cho BTC qua cổng thông tin
                        mà BTC sẽ thông báo kèm với tin công bố danh sách. Các
                        thông tin bao gồm:
                        <br />
                        Họ và tên
                        <br />
                        ...
                        <br />
                        <strong>
                          Đối với người tham gia trúng Giải 3:
                        </strong>{" "}
                        <strong>
                          Trong vòng 20 ngày kể từ ngày công bố kết quả, BTC sẽ
                          liên hệ qua số điện thoại cung cấp trước đó để xác
                          nhận địa chỉ nhận quà theo thứ tự danh sách trúng
                          thưởng. Vui lòng lưu ý nhận điện thoại từ số hotline
                          của BTC sẽ được thông báo kèm với tin công bố danh
                          sách.
                        </strong>
                        <br />
                        <strong>
                          ...
                          tiến hành chuyển phát trao giải trong vòng 20 ngày kể
                          từ ngày xác nhận thông tin nhận giải.
                        </strong>{" "}
                        Mọi vấn đề thất lạc do người thắng giải cung cấp sai
                        thông tin, BTC sẽ không chịu trách nhiệm hoàn trả.
                        <br />
                        Trong trường hợp đã quá thời gian nêu trên, nếu BTC vẫn
                        chưa nhận được thông tin người trúng giải thì giải
                        thưởng sẽ bị hủy bỏ.
                        <br />
                        Trong trường hợp người thắng giải không nhận điện thoại
                        và các hình thức liên lạc khác từ đơn vị vận chuyển của
                        Ban tổ chức thì giải thưởng sẽ bị hủy bỏ.
                        <br />
                        ...
                        <br />
                        ii/. Phần quà được trao dưới dạng voucher tour Đài Loan
                        có trị giá 13 triệu đồng dành cho 01 khách từ Vietravel.
                        Voucher có thể dùng để đổi một chuyến đi Đài Loan trong
                        các gói tour sẵn có của Vietravel, nếu chọn gói tour có
                        giá tiền cao hơn sẽ phải bù tiền, nếu chọn gói có giá
                        tiền thấp hơn thì không được hoàn lại thành tiền mặt.
                        <br />
                        iii/. Voucher có giá trị sử dụng và quy đổi trong vòng
                        01 năm tính từ ngày 01/09/2025
                        <br />
                        ...
                        <br />
                        - Được áp dụng cho mùa LCP năm 2026 tổ chức tại Đài
                        Loan.
                        <br />
                        - Vé vào cổng sẽ được gửi đến user trúng giải ngay khi
                        có thông tin mở bán vé chính thức cho sự kiện từ BTC.
                        <br />
                        <br />
                        <strong>C. Đối với Vé máy bay</strong>
                        <br />
                        i/. Vé máy bay khứ hồi của ba hãng hàng không sẽ được
                        phát ngẫu nhiên cho người chơi thắng cuộc
                        <br />
                        ...
                        <br />
                        iii/. Thời hạn và quy định sử dụng sẽ được quyết định
                        bởi ba hãng hàng không EVA Air, China Airlines, STARLUX.
                        <br />
                        <br />
                        <strong>
                          7. Quy định chung tham gia chương trình:
                        </strong>
                        <br />
                        Nếu trường hợp Người tham gia bị khóa số điện thoại liên
                        lạc hoặc số điện thoại bị mất khả năng liên hệ, Người
                        tham gia sẽ bị xem xét loại khỏi chương trình và tước
                        giải thưởng ở bất kỳ giai đoạn nào, kể cả sau khi đã
                        trao giải.
                        <br />
                        Trong trường hợp có bất kỳ tranh chấp nào phát sinh,
                        ...
                        <br />
                        Cuộc thi tuân thủ nghiêm chỉnh các quy định của pháp
                        luật Việt Nam. Trong trường hợp có tranh chấp xảy ra,
                        BTC có quyền quyết định dựa trên nội dung chương trình
                        và pháp luật Việt Nam hiện hành.
                        <br />
                        Thể lệ chương trình có thể được điều chỉnh trong suốt
                        quá trình cuộc thi diễn ra để phù hợp với tình hình thực
                        tế và đảm bảo công bằng cho người tham gia.
                        <br />
                        Trong trường hợp có sự tranh chấp giải thưởng, BTC và
                        các đơn vị có liên quan không đứng ra giải quyết.
                        <br />
                        <br />
                        <strong>
                        ...
                        <br />
                        Bằng cách tham gia chương trình, Người tham gia đồng ý
                        và tuân theo quy định của bản thể lệ này. Bất kỳ Người
                        tham gia nào vi phạm những quy định và thể lệ của chương
                        trình đều sẽ bị loại và sẽ bị xem xét không được quyền
                        tham gia các chương trình khác do fanpage Cục du lịch
                        Đài Loan tổ chức. Nếu được trúng giải cũng sẽ bị tước
                        giải thưởng theo quyết định của BTC.
                        <br />
                        Người tham gia phải đảm bảo tính xác thực thông tin, nếu
                        cung cấp thông tin không đúng sự thật cho BTC, người
                        tham gia sẽ bị xem xét loại khỏi chương trình và tước
                        giải thưởng ở bất kỳ giai đoạn nào, kể cả sau khi đã
                        trao giải và phải chịu hoàn toàn trách nhiệm trước pháp
                        luật.
                        <br />
                        Người tham gia cam kết và chịu trách nhiệm về bình luận
                        của mình, đảm bảo các quyền hợp pháp khác liên quan đối
                        với bình luận được tạo ra, đảm bảo các quyền này không
                        xâm phạm bất kỳ quyền hợp pháp khác của bất kỳ cá nhân,
                        tổ chức nào.
                        <br />
                        Trong suốt và sau quá trình diễn ra Chương trình, Người
                        tham gia không được đưa ra bất kỳ bình luận chỉ trích
                        hoặc ý kiến nhận định cá nhân nào liên quan đến Chương
                        trình và về các ý kiến bình luận phê bình khác do các
                        bên thứ ba đưa ra đối với lượt tham gia của mình trên
                        bất kỳ phương tiện thông tin truyền thông nào mà có khả
                        năng sẽ gây ra thiệt hại đến tài sản và uy tín của BTC
                        cũng như Cục Du lịch Đài Loan văn phòng tại Thành phố Hồ
                        Chí Minh hoặc Người tham gia khác.
                        <br />
                        ...
                        về giới tính; hướng đến trẻ em, học sinh, sinh viên,
                        thanh niên, phụ nữ mang thai.
                        <br />
                        ...
                        lịch Đài Loan văn phòng tại Thành phố Hồ Chí Minh có
                        quyền sử dụng hình ảnh, bài viết, tên tuổi hay là bất kỳ
                        thông tin cá nhân nào khác mà người tham gia Chương
                        trình đã cung cấp cho BTC cho các mục đích nằm trong
                        khuôn khổ Chương Trình này, bao gồm nhưng không giới hạn
                        quảng cáo, truyền thông, giới thiệu cho Chương trình, mà
                        không phải có thêm bất kỳ sự chấp thuận nào khác cũng
                        như thanh toán bất kỳ khoản chi phí nào liên quan cho
                        Người tham gia.
                        <br />
                        ...
                        Cục Du lịch Đài Loan văn phòng tại Thành phố Hồ Chí
                        Minh, các thông báo từ BTC thông qua các kênh thông tin
                        được Người Tham gia cung cấp.
                        <br />
                        <br />
                        <strong>Quyền và trách nhiệm của BTC:</strong>
                        <br />
                        BTC có quyền loại bỏ bất kỳ lượt tham gia trò chơi nào
                        mà không cần báo trước khi Người tham gia thực hiện
                        những hành động gây ảnh hưởng đến kết quả trung thực của
                        cuộc thi, hoặc vi phạm thể lệ cuộc thi đã được BTC quy
                        định.
                        <br />
                        Trường hợp bất khả kháng như thiên tai, hoả hoạn, hư
                        hỏng máy chủ,... làm thất thoát dữ liệu đăng ký của
                        Người tham gia; BTC giữ quyền quyết định thay đổi hoặc
                        hủy bỏ chương trình và thông báo với Người tham gia dự
                        thi trong thời gian sớm nhất.
                        <br />
                        BTC có quyền sửa đổi, bổ sung thể lệ trong suốt quá
                        trình cuộc thi diễn ra để phù hợp với tình hình thực tế
                        và đảm bảo công bằng cho người tham gia.
                        <br />
                        Trong mọi trường hợp, quyết định của BTC là quyết định
                        cuối cùng. Mọi người tham gia (hoặc có liên quan) đều
                        cần tuân theo quyết định cuối cùng của BTC
                        <br />
                        BTC sẽ không chịu bất kỳ trách nhiệm nào nếu người nhận
                        giải gửi thông tin không đầy đủ theo quy định của thể lệ
                        và/hoặc không chính xác, gian lận. BTC sẽ không chịu
                        trách nhiệm đối với việc giải thưởng bị thất lạc do
                        thông tin Người tham gia cung cấp không chính xác, thiếu
                        thông tin hoặc không liên lạc được với Người tham gia
                        khi nhân viên trao giải thưởng đến giao quà.
                        <br />
                        BTC sẽ trao giải cho người thắng giải thưởng khi chương
                        trình kết thúc, người tham gia tự bảo quản Phiếu mua
                        hàng/thông tin giao hàng, và không tiết lộ cho người
                        khác. BTC sẽ không chịu bất kỳ trách nhiệm nào nếu Phiếu
                        mua hàng/thông tin giao hàng bị tiết lộ sau khi hoàn
                        thành việc giao nhận Phiếu mua hàng/quà tặng cho người
                        thắng giải.
                        <br />
                        Nếu có bất kỳ thay đổi nào về thể lệ của Chương trình,
                        BTC sẽ cập nhật và thông báo trên trang fanpage Cục Du
                        lịch Đài Loan văn phòng tại Thành phố Hồ Chí Minh và
                        website [link website].
                        <br />
                        BTC có toàn quyền sử dụng thông tin cá nhân người tham
                        gia; sử dụng, sao chép, sửa đổi, cắt ghép, cải biên hình
                        ảnh bài dự thi; truyền đạt hình ảnh hoặc một phần hình
                        ảnh với mục đích truyền thông, quảng cáo thương mại trên
                        các kênh truyền thông liên quan đến Cục Du lịch Đài Loan
                        văn phòng tại Thành phố Hồ Chí Minh mà không cần thông
                        báo đến người tham gia.
                        <br />
                        <br />
                        <strong>
                        ...
                        <br />
                        Bằng việc tham gia Chương Trình và cung cấp các dữ liệu
                        cá nhân của mình, Người tham gia đồng ý với các Điều
                        Kiện và Điều Khoản của chương trình và cho phép BTC thu
                        thập và xử lý dữ liệu thông tin cá nhân của người tham
                        gia ("Chủ Thể Dữ Liệu"), cũng như việc chia sẻ thông tin
                        dựa trên theo chính sách dưới đây:
                        <br />
                        <br />
                        <strong>1. Loại dữ liệu cá nhân được xử lý:</strong>
                        <br />
                        - Hình ảnh, video của Chủ Thể Dữ Liệu khi tham gia
                        chương trình….
                        <br />
                        ...
                        - Giới tính;
                        <br />
                        - Nơi sinh, nơi đăng ký khai sinh, nơi thường trú, nơi
                        ...
                        quy định pháp luật và/hoặc yêu cầu hiện hành từ bất kỳ
                        cơ quan có thẩm quyền địa phương, bao gồm cơ quan quản
                        lý, chính phủ, thuế và thực thi pháp luật hoặc các cơ
                        quan có thẩm quyền khác;
                        <br />
                        - Sử dụng hình ảnh, nội dung, thông tin người thắng giải
                        cho mục đích truyền thông nội bộ và truyền thông trên
                        tất cả các nền tảng online và offline.
                        <br />
                        <br />
                        <strong>3. Cách thức xử lý:</strong> Dữ Liệu Cá Nhân sẽ
                        được thu thập, ghi, phân tích, xác nhận, lưu trữ, chỉnh
                        sửa, công khai, kết hợp, truy cập, truy xuất, thu hồi,
                        mã hóa, giải mã, sao chép, chia sẻ, truyền đưa, cung
                        cấp, chuyển giao, xóa, hủy dữ liệu cá nhân hoặc các hành
                        động khác có liên quan.
                        <br />
                        <br />
                        <strong>
                          4. Thời gian bắt đầu, thời gian kết thúc xử lý dữ
                          liệu:
                        </strong>
                        <br />
                        Dữ Liệu Cá Nhân được xử lý tại thời điểm Chủ Thể Dữ Liệu
                        cung cấp cho BTC thông qua việc cung cấp thông tin trong
                        quá trình tham gia chiến dịch và kết thúc xử lý trong
                        thời hạn 10 năm kể từ thời điểm được thu thập hoặc tại
                        thời điểm BTC nhận được yêu cầu hủy bỏ từ Chủ Thể Dữ
                        Liệu.
                        <br />
                        <br />
                        <strong>
                        ...
                        <br />
                        - Tự điều chỉnh hoặc yêu cầu Bên Xử Lý Dữ Liệu điều
                        chỉnh Dữ Liệu Cá Nhân khi Chủ Thể Dữ Liệu nhận thấy Dữ
                        Liệu Cá Nhân của tôi không chính xác;
                        <br />
                        - Được quyền rút lại một phần hoặc toàn bộ sự đồng ý của
                        Chủ Thể Dữ Liệu và yêu cầu Bên Xử Lý Dữ Liệu xóa Dữ Liệu
                        Cá Nhân của Chủ Thể Dữ Liệu đã được cung cấp cho Bên Xử
                        Lý Dữ Liệu;
                        <br />
                        ...
                        Nhân và yêu cầu Bên Xử Lý Dữ Liệu phản hồi, giải trình
                        về việc lộ Dữ Liệu Cá Nhân (nếu có);
                        <br />
                        - Các quyền khác theo quy định tại Bản Xác Nhận này và
                        ...
                        <br />
                        - Cập nhật bằng văn bản cho Bên Xử Lý Dữ Liệu ngay khi
                        có bất kỳ thay đổi nào về Dữ Liệu Cá Nhân đã cung cấp;
                        <br />
                        ...
                        những hành vi sử dụng trái phép, lạm dụng, vi phạm bảo
                        mật của bên thứ ba để Bên Xử Lý Dữ Liệu và các bên liên
                        quan có biện pháp giải quyết phù hợp; và
                        <br />
                        - Các nghĩa vụ khác theo quy định tại Bản Xác Nhận này
                        và quy định của pháp luật
                        <br />
                        <br />
                        <strong>6. Hậu quả thiệt hại không mong muốn</strong>
                        <br />
                        - BTC luôn nỗ lực thực hiện các biện pháp thích hợp
                        trong khả năng về kỹ thuật và an ninh để ngăn chặn việc
                        truy cập, sử dụng trái phép Dữ Liệu Cá Nhân. Dù vậy,
                        không có biện pháp bảo mật dữ liệu nào có thể đảm bảo an
                        toàn tuyệt đối. BTC khuyến cáo Chủ Thể Dữ Liệu nên chủ
                        động thực hiện các biện pháp giúp ngăn chặn việc truy
                        cập trái phép vào mật khẩu, điện thoại và máy tính bằng
                        cách đăng xuất tài khoản sau khi sử dụng máy tính chung,
                        đặt một mật khẩu mạnh và khó đoán và giữ bí mật thông
                        tin đăng nhập cũng như mật khẩu của mình.
                        <br />
                        - BTC luôn ràng buộc các chủ thể tiếp nhận Dữ Liệu Cá
                        Nhân nêu tại Mục 4 Chính Sách này tuân thủ tuyệt đối các
                        cam kết về bảo vệ Dữ Liệu Cá Nhân nhằm bảo vệ tối đa
                        quyền lợi của Chủ Thể Dữ Liệu. Tuy nhiên, trong nhiều
                        trường hợp, BTC không thể kiểm soát tuyệt đối việc các
                        chủ thể này xử lý Dữ Liệu Cá Nhân nằm ngoài phạm vi cho
                        phép hoặc quy định của pháp luật, đặc biệt sau thời điểm
                        chấm dứt các giao dịch liên quan.
      ...
      {/* Success Popup */}
      <SuccessPopup isVisible={showSuccessPopup} onClose={handleClosePopup} />
    </>
  );
};
